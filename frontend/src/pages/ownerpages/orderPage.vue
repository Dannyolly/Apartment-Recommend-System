...
import OrderPageItem from './orderPageItem.vue'
...
onMounted(async ()=>{
    ...
    const { result } =await ServiceManager.LeaseOrderService.list(id)
    console.log(result);
